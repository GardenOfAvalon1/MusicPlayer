...
public class MusicInfoFragment extends Fragment {
    ...
    private void initView() {
        ...
        seekBar = view.findViewById(R.id.info_seekBar);//进度条
        ...
        seekBar.setMax(musicService.getDuration());//获得总时长
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {//回调函数
            @Override
            ...
            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {//拖动结束
                musicService.seekTo(seekBar.getProgress());//定位seekbar到当前时间对应位置
            }
        });
